...
import { BuildingOfficeIcon, HomeModernIcon, HomeIcon, AcademicCapIcon, BookOpenIcon, UserGroupIcon, CalendarDaysIcon, CalendarIcon, ClipboardDocumentCheckIcon, ClipboardDocumentListIcon, ShoppingBagIcon, DocumentTextIcon, ChartBarIcon } from '@heroicons/react/24/outline';
